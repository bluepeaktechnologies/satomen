...
function Card({ Icon, title, desc, className = "" }) {
  return (
    <motion.div
      variants={scaleIn}
      whileHover={{ y: -6, boxShadow: "0 12px 25px rgba(0,0,0,0.2)" }}
      transition={{ type: "spring", stiffness: 120, damping: 12 }}
      className={`border border-white/15 bg-[#0a2b4a] p-8 rounded-xl transition-all ${className}`}
    >
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-16 lg:py-20">
        ...
        >
          ...
          {/* Top two cards */}
          <motion.div
            className="lg:col-span-8 lg:-ml-2 grid grid-cols-1 gap-8 md:grid-cols-2"
