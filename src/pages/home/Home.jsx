...
function AnimatedMetric({ value, className = "", duration = 1200 }) {
  ...
  const { ref, value: animated } = useCountUp({ end: num, decimals, duration, once: true });
  return (
      ...
      <section className="relative overflow-hidden bg-[#0a2741]">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 pb-16 pt-8 md:grid-cols-12 md:pt-14 lg:gap-10">
          ...
          <div className="md:col-span-6">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-white/80 font-bold">{h.body}</p>
          ...
          <div className="relative md:col-span-6">
            ...
            <div className="relative mt-4 sm:mt-6 md:mt-0 lg:pr-8">
              ...
              <div
                ...
                "
              >
                <h3 className="text-lg font-semibold text-slate-900 sm:text-xl">{h.card.title}</h3>
                ...
                <div className="mt-2 text-2xl font-extrabold text-emerald-600 sm:text-3xl">
                  ...
                  &nbsp;m<sup className="align-super text-sm sm:text-base">{h.card.metricSup}</sup>
                </div>

                <div className="mt-1 text-sm text-slate-600">{h.card.metricLabel}</div>
                <a
                  href="#details"
